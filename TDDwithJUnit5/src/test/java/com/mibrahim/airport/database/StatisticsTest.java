...
import com.mibrahim.airport.extention.MockitoExtension;
...
public class StatisticsTest {
	...
	void before() {
		...
		List<String> row1 = Arrays.asList("1", "e", "Mohamed", "false", "349");
		List<String> row2 = Arrays.asList("2", "b", "Ibrahim", "true", "278");
		List<String> row3 = Arrays.asList("3", "e", "Mohamed", "false", "319");
		List<String> row4 = Arrays.asList("4", "p", "Ibrahim", "true", "817");
		List<String> row5 = Arrays.asList("5", "e", "Mohamed", "false", "623");
		List<String> row6 = Arrays.asList("6", "e", "Ibrahim", "true", "978");
